...
public class UserPassword 
{
    public static void main( String[] args )
    {
        ...
        // print out a user object including the first name, last name, email, birth year, favorite color, animal, and season
        // printed above to test the scanners, but commented out now
        System.out.println( "Your first name is: " + user1.getFirstName() );
        System.out.println( "Your last name is: " + user1.getLastName() );
        System.out.println( "Your email is: " + user1.getEmail() );
        System.out.println( "Your birthyear is: " + user1.getBirthYear() );
        ...
        System.out.println("\n" + "Your password is: " + user1.getPassword());
